...
{
    public class AngleDividerStructure : BaseStructure
    {
        public double MaxAngleAYC { get; init; } = Angles.Deg45;
        public double MaxAngleBYC { get; init; } = Angles.Deg90;

        public override double MaxAngle => MaxAngleAYC + MaxAngleBYC;
        ...
        public Vector3 C => new Vector3((float)(Width * Math.Cos(Axis.Angle / MaxAngle * MaxAngleAYC)), (float)Height, (float)(Width * Math.Sin(Axis.Angle / MaxAngle * MaxAngleAYC)));
